...
class __TwigTemplate_d5cc7a2b30ca8cc6cb6785ec8c7b85d1666c968591deb14ce49c7633a498e7a5 extends \Twig\Template
{
...
";
    ...
    public function block_meta($context, array $blocks = [])
    {
        ...
        if ($this->getAttribute($this->getAttribute(($context["gantry"] ?? null), "config", []), "get", [0 => (("content." . ($context["scope"] ?? null)) . ".meta-comments.enabled"), 1 => "1"], "method")) {
            ...
            if (($this->getAttribute(($context["post"] ?? null), "comment_count", []) == "0")) {
                // line 55
                echo "                    ";
                $context["comment_count"] = __("No comments", "g5_helium");
                // line 56
                echo "                ";
            } elseif (($this->getAttribute(($context["post"] ?? null), "comment_count", []) == "1")) {
                // line 57
                echo "                    ";
                $context["comment_count"] = (($this->getAttribute(($context["post"] ?? null), "comment_count", []) . " ") . __("Comment", "g5_helium"));
                // line 58
                echo "                ";
            } else {
                // line 59
                echo "                    ";
                $context["comment_count"] = (($this->getAttribute(($context["post"] ?? null), "comment_count", []) . " ") . __("Comments", "g5_helium"));
                // line 60
                echo "                ";
            }
            // line 61
    ...
    {
        return new Source("", "partials/meta.html.twig", "C:\\xampp\\htdocs\\drugiProjekatEP\\wordpress\\wp-content\\themes\\g5_helium\\views\\partials\\meta.html.twig");
    }
}
