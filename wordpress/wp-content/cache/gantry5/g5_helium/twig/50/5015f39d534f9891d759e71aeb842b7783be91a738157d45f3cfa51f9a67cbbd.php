...
class __TwigTemplate_6dc4042591fe3b194969c7a3a425fe893099b2740a2e4be0d3371bcf77abecb1 extends \Twig\Template
{
...
($context["gantry"] ?? null), "config", []), "get", [0 => (("content." . ($context["scope"] ?? null)) . ".content.type"), 1 => "content"], "method") == "gexcerpt")) {
                    // line 49
                    echo "                        <div class=\"post-excerpt\">";
                    echo call_user_func_array($this->env->getFilter('apply_filters')->getCallable(), [$this->getAttribute($this->getAttribute($this->getAttribute(($context["post"] ?? null), "preview", []), "length", [0 => $this->getAttribute($this->getAttribute(($context["gantry"] ?? null), "config", []), "get", [0 => (("content." . ($context["scope"] ?? null)) . ".content.gexcerpt-length"), 1 => "50"], "method")], "method"), "read_more", [0 => false], "method"), "the_excerpt"]);
                    echo "</div>
                    ";
                } else {
                    // line 51
...
($context["post"] ?? null), "post_content", []))) {
    ...
    {
        return new Source("", "partials/content.html.twig", "C:\\xampp\\htdocs\\drugiProjekatEP\\wordpress\\wp-content\\themes\\g5_helium\\views\\partials\\content.html.twig");
    }
}
